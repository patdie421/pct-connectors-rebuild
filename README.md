...
This repository consolidate all the elements which allow to use an "AE PC Transporter" card in an Apple IIe (my first usage) or IIgs. In particular, It contains elements allowing to recreate the cables and connectors which are generally lost when one of these cards is found.  
