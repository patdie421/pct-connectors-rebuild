...
## Colorswitch
The ColorSwitch was designed to allow a PCT-equipped Apple IIGS to display CGA on a standard A2M6014 monitor or a compatible RGB monitor. When the PCT software is launched, the display automatically switches Apple screen to CGA screen.
